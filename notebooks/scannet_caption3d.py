...
# %%
# --- Configuration ---
CONFIG_NAME = "data/mosaic3d++/sn+ar_3d_caption.yaml"
...
for dataset in datamodule.data_train.datasets:
    print(f"Using dataset: {type(dataset).__name__}")
...
data_dict = datamodule.data_train.datasets[1][SCENE_INDEX]
print(
